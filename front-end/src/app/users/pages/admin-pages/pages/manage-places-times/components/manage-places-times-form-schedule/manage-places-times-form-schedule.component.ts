...
import { SelectedCondtionService } from '../../services/SelectedCondtion.service';
...
export class ManagePlacesTimesFormScheduleComponent implements OnInit {
  ...
  constructor(
    ...
    public selectedDayService: SelectedDayService,
    public selectedCondtionService: SelectedCondtionService,
  ) {}
  ...
  ngOnInit(): void {
    ...
    this.selectedDayService.isSelectedDisplay = false;
    this.selectedCondtionService.isSelectedDisplay = false;
