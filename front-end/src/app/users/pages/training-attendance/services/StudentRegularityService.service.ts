...
import { TrainingAttendanceService } from './TrainingAttendanceService.service';
...
export class StudentRegularityService {
  ...
  private get planningService(): TrainingAttendanceService {
    return this.injector.get(TrainingAttendanceService);
  }
