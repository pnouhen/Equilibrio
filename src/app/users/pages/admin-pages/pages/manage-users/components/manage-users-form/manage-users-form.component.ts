...
import { SelectedStatutService } from './../../services/SelectedStatut.service';
...
export class ManageUsersFormComponent implements OnInit {
  ...
  constructor(
    public selectedStatutService: SelectedStatutService,
  ...
  onSubmitForm() {
    ...
    if (isSubmitFormValid) {
      ...
      if (this.manageUsersService.idForm) {
        ...
        // Managing the display of the message after submit
        this.formMessages[0].text = "L'adhérant a bien été ajouté";
      }
