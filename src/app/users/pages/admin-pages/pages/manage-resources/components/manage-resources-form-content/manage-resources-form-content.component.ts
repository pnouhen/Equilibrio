...
import { SelectedCategoryUserDataContentService } from '../../services/SelectedCategoryUserDataContent.service';
import { SelectedTypeUserDataContentService } from '../../services/SelectedTypeUserDataContent.service';
...
export class ManageResourcesFormContentComponent implements OnInit {
  ...
  constructor(
    public selectedCategoryUserDataContentService: SelectedCategoryUserDataContentService,
    public selectedTypeUserDataContentService: SelectedTypeUserDataContentService,
    public manageResourcesFormService: ManageResourcesFormService,
    public selectedLinkGrade: SelectedGradeService,
