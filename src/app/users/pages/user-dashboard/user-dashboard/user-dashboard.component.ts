...
import { UserDashboardContentComponent } from '../components/user-dashboard-content/user-dashboard-content.component';
import { LinkUserMenuData } from '../../../datas/linkUserMenu.data';

@Component({
  selector: 'app-user-dashboard',
  imports: [UserDashboardMenuComponent, UserDashboardContentComponent],
