...
import { UserDashboardSlideShowComponent } from '../user-dashboard-slide-show/user-dashboard-slide-show.component';
...
export class UserDashboardContentComponent {
  ...
  UserDashboardData!: UsersDataModel | undefined;
  ...
  effect(() => {
    ...
    this.UserDashboardData = this.updateContent();
