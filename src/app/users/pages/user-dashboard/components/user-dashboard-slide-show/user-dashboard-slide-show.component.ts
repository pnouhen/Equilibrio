...
import { UserDashboardSlidesComponent } from "../user-dashboard-slides/user-dashboard-slides.component";

@Component({
  selector: 'app-user-dashboard-slide-show',
  imports: [UserDashboardSlidesComponent],
  templateUrl: './user-dashboard-slide-show.component.html',
  styleUrl: './user-dashboard-slide-show.component.scss',
})
export class UserDashboardSlideShowComponent implements OnInit {
